...
@app.route("/user/getSuspendedEventOrganizers")
...
@app.route("/user/approveEventOrganizer", methods=["POST"])
...
@app.route("/user/suspendEventOrganizer", methods=["POST"])
def suspend_event_organizer():
    ...
    if event_organizer:
        ...
        return jsonify({"message": "Event organizer not found", "code": 404}), 404
@app.route("/user/UnSuspendEventOrganizer", methods=["POST"])

...
class TestYourAPI(unittest.TestCase):
    ...
    def test_suspend_event(self):
        ...
        response = self.app.delete('/category/suspend/1')
        ...
        if response.status_code == 200:
            ...
            self.assertEqual(response_data["message"], "Category with categoryId 1 has been deleted.")
        elif response.status_code == 404:
            self.assertEqual(response_data["message"], "Category not found.")

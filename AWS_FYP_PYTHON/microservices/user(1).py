...
producer_config = {
    ...
    'client.id': 'register'  # Choose a client ID
}

producer = Producer(producer_config)
def publish_registration_event(username):
    topic = 'register'  # Replace with the Kafka topic you want to publish to
...
def create_user():
    ...
    try:
        ...
        publish_registration_event(email)
        if user_type == "2":
        ...
        return jsonify({"data": Add_EventGoer.json(), "code": 201}), 201
